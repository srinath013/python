...
def adddonar():
    ...
    def add():
       ...
       if(phone.isdigit()==TRUE and len(phone)<10):
        ...
        con=mysql.connect(host="localhost",user="root",password="1234",database="bld")
        cur=con.cursor()
...
img4 = ImageTk.PhotoImage(Image.open(r"C:\Users\Srinath\OneDrive\Desktop\Project\w1.jpg"))

btn1 = ImageTk.PhotoImage(Image.open(r"C:\Users\Srinath\OneDrive\Desktop\Project\q.png"))

root.geometry("960x480+100+50")
photo = PhotoImage(file = r"C:\Users\Srinath\OneDrive\Desktop\Project\q.png")
